...
const useFranchises = () => {
  ...
  useEffect(() => {
    fetchFranchises();
  }, [page, pageSize, filterModel]); // Ensure axiosPrivate is included as a dependency
  ...
  return { franchises, franchisesLoading, error, fetchFranchises };
};
