...
class ReceiptViolationPrintableGF extends Component {
  render() {
    ...
    if (violationDetails) {
      ...
      totalAmount = (total || 0) * 0.63; // Ensure total defaults to 0 if undefined
...
export default ReceiptViolationPrintableGF;
